...
## 1. Introducción
En esta práctica se realiza la captura de datos de sensores de una pinza robótica industrial, su almacenamiento en ficheros y posteriormente su análisis mediante C++ y un script de Bash.
...
- Automatice la ejecución del programa mediante un script de Bash (`ejecutar.sh`) lanzando el programa en segundo plano y controlando su finalización.
